...
" call s:my_highlight('PMenu',            '#xxxxxx', '#xxxxxx', '#xxxxxx', 'NONE')  " ポップアップメニュー: 通常のテキスト
" call s:my_highlight('PMenuSel',         '#xxxxxx', '#xxxxxx', '#xxxxxx', 'NONE')  " ポップアップメニュー: 選択されている項目
" call s:my_highlight('PMenuSbar',        '#xxxxxx', '#xxxxxx', '#xxxxxx', 'NONE')  " ポップアップメニュー: スクロールバー
" call s:my_highlight('PMenuThumb',       '#xxxxxx', '#xxxxxx', '#xxxxxx', 'NONE')  " ポップアップメニュー: スクロールバーのつまみ部分
...
" call s:my_highlight('Search',           '#xxxxxx', '#xxxxxx', '#xxxxxx', 'NONE')  " 最後に検索した語のハイライト 
" call s:my_highlight('CurSearch',        '#xxxxxx', '#xxxxxx', '#xxxxxx', 'NONE')  " 最後に検索した語のハイライト
